  ...
  const experiences = [
    {
      ...
      points: [
        "Programmed software for Minecraft using Java",
        "Worked with clients to create programs that meet their needs",
        "Integrated MySQL databases with software allowing organized data storage and faster data queries",
      ],
    },
    {
      ...
      points: [
        "Developed software for touch-probe sensor attachment to FFF 3D printer",
    ...
    },
    {
      ...
      company_name: "FANUC America Corporation",
      icon: shopify,
      iconBg: "#383E56",
